"""
OPT-125M  ×  SynthID-Text  (Tournament Sampling)
=================================================
...
Algorithm  (identical to experiments/gpt2/synthid.py)
------------------------------------------------------
...
Run
---
    python experiments/opt_125m/synthid.py
"""
...
def main() -> None:
    print("=" * 72)
    print("  OPT-125M  ×  SynthID-Text  (Tournament Sampling)")
    print("=" * 72)
    print(f"\n  Model        : {MODEL_ID}")
